...
// The product ships one browser engine: standalone pcbnew. Project-management,
// schematic, library-editor, 3D/OCC and manufacturing-viewer bundles are outside
// the PCB-only contract and are not published.
const TOOLS = ["pcbnew"];
